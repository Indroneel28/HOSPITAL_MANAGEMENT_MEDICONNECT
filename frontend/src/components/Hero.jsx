    ...
    <>
      <div className="hero container">
        <div className="banner">
          ...
          With MediConnect, booking hospital beds, finding top doctors, and exploring nearby treatments has never been easier or faster.
          Our app connects you directly to hospitals in real-time, allowing you to check bed availability, compare treatments, and book appointments—all from the comfort of your home. 
