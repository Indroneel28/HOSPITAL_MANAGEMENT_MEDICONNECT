    ...
    <>
      <div className="container biography">
        ...
        <div className="banner">
          ...
          MediConnect is designed to simplify every step of your healthcare journey.
          Our app offers real-time updates on bed availability, 
          allowing you to secure hospital rooms during critical moments without the stress of visiting multiple facilities.
           ...
           Whether you're looking for specialized surgeries, rehabilitation, or routine check-ups, our platform provides detailed descriptions, doctor qualifications, and patient reviews for informed decision-making.
